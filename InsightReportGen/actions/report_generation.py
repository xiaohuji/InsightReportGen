...
async def generate_report(
    ...
    **kwargs
    ...
    if report_type == "subtopic_report":
        content = f"{generate_prompt(query, existing_headers, relevant_written_contents, main_topic, context, report_format=cfg.report_format, tone=tone, total_words=1000, language=cfg.language)}"
    elif custom_prompt:
